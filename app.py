...
# try:
#     if os.path.exists("blast_furnace_model.pkl") and os.path.exists("blast_furnace_scaler.pkl"):
#         model = joblib.load("blast_furnace_model.pkl")
#         scaler = joblib.load("blast_furnace_scaler.pkl")
#         st.success("✅ Model Loaded Successfully")
#     else:
#         st.error("❌ Model files not found in this directory.")
# except Exception as e:
#     st.error(f"❌ Model Loading Error: {e}")

# # Stop execution if model not loaded
